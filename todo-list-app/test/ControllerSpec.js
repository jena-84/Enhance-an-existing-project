...
describe('controller', function () {
	...
	//Show App with empty array and no added tasks
    ...
    // Show 'All' as a default to show all tasks(completed and not completed) even when no added task
    ...
    // Change the the active status of the task
	describe('toggle all', function () {
        ...
        //Update the model  status as completed 
